...
module.exports.run = async(client, message, args) => {
    ...
    if (!member) return message.channel.send(new client.embed().setDescription(`Please specify a user to view warnings on.`).setFooter(`${message.guild.name} `, message.guild.iconURL({ dynamic: true })))
